...
export default function WarehouseDocumentCreate() {
    ...
    const [items, setItems] = useState([{ product_id: '', quantity: 1, unit_price: '', vat_rate: '' }]);
                ...
                <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                        <Field label="Numer">
                            ...
                            />
                            <span className="text-xs text-gray-500">Pozostaw puste, aby numer został nadany automatycznie.</span>
...
WarehouseDocumentCreate.layout = (page) => <DashboardLayout title="Nowy dokument magazynowy">{page}</DashboardLayout>;
